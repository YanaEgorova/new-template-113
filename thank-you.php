        ...
        <footer class="footer">
          <div class="footer__top">
            <div class="footer__right">
              ...
              <a href="./cancellation.html" class="text footer__link footer__page-link">
                <span class="footer__link-span">Cancellation</span>
              </a>
            </div>
            <div class="footer__left">
              <p class="footer__title">Our Contacts</p>
              <p class="text js_website-corp">website corp</p>
              ...
              <p class="text footer__text">
                <span class="bold">Address:</span> <span class="footer__link footer__link-no js_website-address">website address</span>
              </p>
              <div class="footer__text">
                <span class="text bold">Phone:</span>
                <a href="tel:website phone" class="text footer__link footer__text js_website-phone">website phone</a>
              </div>
              
              <p class="text">Return Address: <span class="js_website-return-address">website return address</span></p>
            </div>
          
            <div class="logo__box">
              <a href="./index.html" class="footer__logo logo js_logo-data" data-text="website name">
              <span class="js_website-name">website name</span>
              </a>
            </div>
          </div>
